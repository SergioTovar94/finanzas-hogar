...
**Versión:** 1.0 **Fecha:** 31 de marzo de 2026 **Estado:** Aprobado
...
| ---------------------- | -------------------------- |
| MS-1 Backend core      | Spring Boot 3 — Java 21    |
| MS-2 Backend analytics | Django 5 — Python 3.12     |
